...
enum TriadQuality: CaseIterable, Codable {
    case major, minor
...
enum TriadInversion: CaseIterable {
...
enum StringGroup: CaseIterable, Codable {
...
let allTriadShapes: [TriadShape] = [
    ...
    TriadShape(id: "maj-root-123",  quality: .major, inversion: .root,
               stringGroup: .strings1_2_3, fretOffsets: [2, 2, 0], rootStringIndex: 2),

    TriadShape(id: "maj-first-123", quality: .major, inversion: .first,
               stringGroup: .strings1_2_3, fretOffsets: [1, 0, 0], rootStringIndex: 0),
    ...
    TriadShape(id: "min-root-123",  quality: .minor, inversion: .root,
               stringGroup: .strings1_2_3, fretOffsets: [2, 1, 0], rootStringIndex: 2),

    TriadShape(id: "min-first-123", quality: .minor, inversion: .first,
               stringGroup: .strings1_2_3, fretOffsets: [0, 0, 0], rootStringIndex: 0),

    TriadShape(id: "min-sec-123",   quality: .minor, inversion: .second,
               stringGroup: .strings1_2_3, fretOffsets: [1, 2, 0], rootStringIndex: 1),
