            ...
            Form {
                ...
                Section {
                    Stepper("Choices: \(session.choiceCount)",
                            ...
                            in: 4...(session.naturalsOnly ? 7 : 12))
                } header: {
                    Text("Difficulty")
                } footer: {
                    Text("Fewer choices makes it easier. Max is \(session.naturalsOnly ? 7 : 12) for the current note set.")
                }
                ...
                Section {
                    ...
                    Text("Play the note when each question appears and when you answer.")
                }
